...
export default function PrivacyPolicy() {
  return (
    ...
    <div className="flex flex-col p-4">
      ...
      <h2>Google Ads and Google Analytics</h2>

      <p>
        We use Google Ads and Google Analytics to serve personalized ads and
        analyze user behavior on our Site. These services may collect and
        process data, such as IP addresses, browser information, and usage
        patterns. This data is used to improve our services and provide relevant
        advertisements.
      </p>
      ...
      <p>
        This Privacy Policy is effective as of August 10, 2023 and will remain
